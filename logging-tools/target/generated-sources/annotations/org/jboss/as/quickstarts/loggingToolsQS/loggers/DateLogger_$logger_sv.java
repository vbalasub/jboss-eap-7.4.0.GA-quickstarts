...
public class DateLogger_$logger_sv extends DateLogger_$logger implements DateLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public DateLogger_$logger_sv(final org.jboss.logging.Logger logger) {
        super(logger);
    }
